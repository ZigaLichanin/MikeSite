...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<?php include'Php/logindata.php'?>
	 <?php include 'Php/getresults.php';?>
...
<li><form action="searchresults.php" method="post">
	...
	<button class="btn waves-effect waves-light grey darken-3 z-depth-3" type="submit"  name="post-btn">Search
  ...
  <!--Collapsible forum navigation to show our threads-->
    ...
    <li>
      <div class="collapsible-header grey darken-4" id="collapsible"><i class="material-icons">explore</i>Posted Questions</div>
